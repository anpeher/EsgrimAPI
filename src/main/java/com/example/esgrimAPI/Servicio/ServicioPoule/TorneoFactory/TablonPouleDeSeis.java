...
public class TablonPouleDeSeis implements TablonPoule{
    @Override
    public List<Enfrentamiento> generarEnfrentamientos(List<Participante> participantes, Poule poule) {
        ...
        enfrentamientos.add(new Enfrentamiento(participantes.get(5), participantes.get(3), poule));
        ...
        enfrentamientos.add(new Enfrentamiento(participantes.get(5), participantes.get(2), poule));
        enfrentamientos.add(new Enfrentamiento(participantes.get(4), participantes.get(1), poule));
        enfrentamientos.add(new Enfrentamiento(participantes.get(0), participantes.get(2), poule));
        enfrentamientos.add(new Enfrentamiento(participantes.get(5), participantes.get(1), poule));
        enfrentamientos.add(new Enfrentamiento(participantes.get(4), participantes.get(3), poule));
        enfrentamientos.add(new Enfrentamiento(participantes.get(0), participantes.get(1), poule));
        enfrentamientos.add(new Enfrentamiento(participantes.get(5), participantes.get(4), poule));
        enfrentamientos.add(new Enfrentamiento(participantes.get(2), participantes.get(1), poule));
